...
// 	// asdf_write_to_file( $values );

// 	asdf_write_to_file( $post_id );
// 	return $post_id;
// }
...
// add_filter( 'acf/update_value/key=field_5e441588438a3', function( $value, $post_id, $field ) {
...
function asdf_write_to_file( $value ) {
	/**
