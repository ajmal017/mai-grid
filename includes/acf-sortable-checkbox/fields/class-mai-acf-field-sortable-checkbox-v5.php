...
if( ! class_exists('mai_acf_field_sortable_checkbox') ) :

class mai_acf_field_sortable_checkbox extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'sortable_checkbox';
		$this->label = __( "Sortable Checkbox", 'acf' );
	...
	function input_admin_enqueue_scripts() {
		...
		// vars
		$url     = MAI_GRID_PLUGIN_URL . 'includes/acf-sortable-checkbox/';
		$version = '0.1.0';

		// register & include JS
		wp_register_script( 'mai-acf-sortable-checkbox', "{$url}assets/js/input.js", array('acf-input'), $version );
		wp_enqueue_script( 'mai-acf-sortable-checkbox');

		// register & include CSS
		wp_register_style( 'mai-acf-sortable-checkbox', "{$url}assets/css/input.css", array('acf-input'), $version );
		wp_enqueue_style( 'mai-acf-sortable-checkbox');
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		$li = '';
		$ul = array(
			'class' => 'acf-sortable-checkbox-list',
		);
	...
	*/
	...
	function walk( $choices = array(), $args = array(), $depth = 0 ) {
		...
		foreach( $choices as $value => $label ) {
			...
			// option
				...
				// append
				$html .= $this->get_checkbox_input( $atts );
	...
	function get_checkbox_input( $attrs ) {
		...
		$icon = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z"/></svg>';
...
// initialize
acf_register_field_type( 'mai_acf_field_sortable_checkbox' );
